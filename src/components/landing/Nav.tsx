    ...
    <>
      <nav className={scrolled ? "scrolled" : ""}>
        ...
        <div className="nav-right">
          <ThemeToggle />
          <Link href="/auth" className="nav-signin desktop-only">
          ...
          >
            {t("nav", "getStarted") || "Get Started"} <ArrowIcon />
          </Link>
      ...
      <div className={`nav-mobile ${isMobileOpen ? "open" : ""}`}>
        ...
        <Link href="#usecases" onClick={closeMobileMenu}>
          {t("nav", "useCases") || "Use Cases"}
        </Link>
        ...
        <div className="nav-mobile-actions">
          <Link href="/auth" className="nav-signin" onClick={closeMobileMenu}>
            {t("nav", "signIn") || "Sign In"}
          </Link>
          <Link 
            href="/auth?mode=register" 
